...
//    1.2 Verify the text “Shipping”
        verifyTextWithAssert("Shipping",By.xpath("//h1[@id='page-title']"),"text is verified");
    }
@Test
...
//		2.2 Verify the text “New arrivals”
        verifyTextWithAssert("New arrivals",By.xpath("//h1[@id='page-title']"),"text is verified");
    }
    @Test
...
//        3.2 Verify the text “Coming soon”
        verifyTextWithAssert("Coming soon",By.xpath("//h1[@id='page-title']"),"text is verified");
}
@Test
...
//		4.2 Verify the text “Contact us”
        verifyTextWithAssert("Contact us",By.xpath("//h1[@id='page-title']"),"text is verified");

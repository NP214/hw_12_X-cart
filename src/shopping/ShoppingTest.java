...
//    1.3 Verify the text “Bestsellers”
    Thread.sleep(2000);
    verifyTextWithAssert("Bestsellers",By.xpath("//h1[@id='page-title']"),"text is verified");
...
//    1.6 Verify the message “Product has been added to your cart” display in  green bar
    verifyTextWithAssert("Product has been added to your cart",By.xpath("//li[contains(text(),'Product has been added to your cart')]"),"text is verified");
...
//    1.10 Verify the Subtotal $99.00
    Thread.sleep(3000);
    verifyTextWithAssert("Subtotal: $9.99",By.xpath("//ul[@class='sums']/li"),"price is verified");
//    1.11 Verify the total $106.23
    Thread.sleep(2000);
    verifyTextWithAssert("$12.59",By.xpath("//ul[@class='totals']/li[4]/span"),"price is verified");
...
//    1.13 Verify the text “Log in to your account”
    Thread.sleep(1000);
    verifyTextWithAssert("Log in to your account",By.xpath("//div[@class='signin-wrapper']/div[1]/div[1]/h3"),"text is verified");
...
//    1.16 Verify the text “Secure Checkout”
    verifyTextWithAssert("Secure Checkout",By.xpath("//div[@class='checkout-block']/h1"),"text is verified");
...
//    1.22 Verify the total $99.00
    verifyTextWithAssert("$13.61",By.xpath("//div[@class='total clearfix']/span/span"),"text is verified");
...
verifyTextWithAssert("Thank you for your order",By.xpath("//h1[@id='page-title']"),"text is verified");
}
@Test
